...
<script type="text/javascript" src="<%=basePath%>/js/stateManage.js"></script>
</head>
<body class="easyui-layout">
	...
	<div data-options="region:'center'">
		<table id="dg"toolbar="#toolbar" title="状态字典维护" pagination="true" idField="id" rownumbers="true" fit="true" singleSelect="true">
			<thead>
				<tr>
					<th field="name" width="100" editor="{type:'validatebox',options:{required:true}}">状态名称</th>
				</tr>
			</thead>
		</table>
		<div id="toolbar">
