...
<script type="text/javascript" src="<%=basePath%>/js/privateFacilitiesManage.js"></script>
</head>
<body class="easyui-layout">
	<div data-options="region:'center'">
	 ...
	 <div data-options="region:'south',title:'小区设施',split:true" style="height:400px;">
	 	<div data-options="buttons:'#dlg-buttons'" style="width:1100px;background-color:rgb(199, 225, 245);height:385px">
			...
			<form id="communalFacilities_form" method="post">
				...
				<table style="width:1000px;height:250px">
					...
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;设施类型： <input id="communalFaStyleId" name="communalFaStyleId" data-options="required:true" style="width:180px;"/></td>
